...
<link rel="stylesheet" type="text/css" href="hanna.css">
...
<script>
  ...
  ga('send', 'pageview');
	...
	<div class="btn_area"><a href="/download" target="_blank"><img src="btn_download.png" alt="Get Free ScreenSaver for MAC"></a></div>
	<?php }?>
